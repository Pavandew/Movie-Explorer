...
import com.example.movieexplorer.ui.home.component.BodyContent
import com.example.movieexplorer.ui.home.component.TopContent
...
fun HomeScreen(
    ...
    Box(modifier = Modifier) {
        AnimatedVisibility(visible = state.error != null) {
            Text(text = state.error ?: "unknow error",
